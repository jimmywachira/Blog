<div>
    <div class="max-w-2xl mx-auto bg-white/10 backdrop-blur-sm rounded-2xl shadow-lg overflow-hidden">
        <div class="p-6 sm:p-8">
            <h1 class="text-3xl font-bold text-white text-center mb-6">Create Article</h1>
            ...
            <form wire:submit="save" class="space-y-6">
                <div>
                    ...
                    <input type="text" id="title" wire:model="form.title" class="w-full rounded-md border-0 bg-white/5 py-2 px-3 text-white ring-1 ring-inset ring-white/10 placeholder:text-white/50 focus:ring-2 focus:ring-inset focus:ring-gray-500 sm:text-sm sm:leading-6" placeholder="Enter article title">
                    <div> @error('form.title') <span class="text-red-500 mt-2 p-2 text-sm">{{ $message }}</span> @enderror</div>
                </div>
                <div>
                    ...
                    <textarea id="body" wire:model="form.content" rows="6" class="w-full rounded-md border-0 bg-white/5 py-2 px-3 text-white ring-1 ring-inset ring-white/10 placeholder:text-white/50 focus:ring-2 focus:ring-inset focus:ring-gray-500 sm:text-sm sm:leading-6" placeholder="Enter article content"></textarea>
                    <div> @error('form.content') <span class="text-red-500 mt-2 text-sm">{{ $message }}</span> @enderror</div>
                </div>
                ...
                <div x-data="{ allow: @entangle('form.allowNotifications') }" x-show="allow" class="flex mt-2 gap-6">
                    <label class="flex items-center">
